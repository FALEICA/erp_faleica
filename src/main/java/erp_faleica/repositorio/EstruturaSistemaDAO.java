...
public class EstruturaSistemaDAO implements Serializable {
	...
	public List<EstruturaSistemaModel> getModulos(User user) {
		String sqlTxt = "SELECT\r\n"
				+ "us.usu_Id,\r\n"
				+ "us.usu_Cod,\r\n"
				+ "ac.modulo_CodNumber as cod_Modulo,\r\n"
	...
	public List<EstruturaSistemaModel> getMenus(User user, Integer modulo) {
		String sqlTxt = "SELECT\r\n"
				+ "us.usu_Id,\r\n"
				+ "us.usu_Cod,\r\n"
				+ "ac.modulo_CodNumber as cod_Modulo,\r\n"
				...
				+ "\r\n"
				+ "where\r\n"
				+ "us.usu_Cod = ? and ac.modulo_CodNumber = ?";
	...
	public List<EstruturaSistemaModel> getComponentes(User user, Integer modulo, Integer componente) {
		String sqlTxt = "SELECT\r\n"
				+ "us.usu_Id,\r\n"
				+ "us.usu_Cod,\r\n"
				+ "ac.modulo_CodNumber as cod_Modulo,\r\n"
				...
				+ "\r\n"
				+ "where\r\n"
				+ "us.usu_Cod = ? and ac.modulo_CodNumber = ? and ac.menu_CodNumber = ?";
